        ...
        <div className="pt-6">
          ...
          <div
            ...
            <div className="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
              <h1
                className="text-2xl font-bold tracking-tight text-gray-600 dark:text-gray-400 sm:text-3xl transition duration-500">{product.name}</h1>
            </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <p
                className="text-3xl tracking-tight text-gray-600 dark:text-gray-400 transition duration-500">{product.price}</p>
                    ...
                    {[0, 1, 2, 3, 4].map((rating) => (
                      <StarIcon
                        ...
                        className={classNames(
                          reviews.average > rating ? 'text-gray-600 dark:text-gray-400 transition duration-500' : 'text-gray-200',
              ...
              <form className="mt-10">
                ...
                <div>
                  <h3
                    className="text-sm font-medium text-gray-600 dark:text-gray-400 transition duration-500">Color</h3>
                ...
                <div className="mt-10">
                  <div className="flex items-center justify-between">
                    <h3
                      className="text-sm font-medium text-gray-600 dark:text-gray-400 transition duration-500">Size</h3>
            ...
            <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <p
                    className="text-base text-gray-600 dark:text-gray-400 transition duration-500">{product.description}</p>
                </div>
              </div>

              <div className="mt-10">
                <h3
                  className="text-sm font-medium text-gray-600 dark:text-gray-400 transition duration-500">Highlights</h3>

                <div className="mt-4">
                  <ul role="list" className="list-disc space-y-2 pl-4 text-sm">
                    {product.highlights.map((highlight) => (
                      <li key={highlight} className="text-gray-400">
                        <span className="text-gray-600 dark:text-gray-400 transition duration-500">{highlight}</span>
                      </li>
                    ))}
                  </ul>
                </div>
              ...
              <div className="mt-10">
                <h2
                  className="text-sm font-medium text-gray-600 dark:text-gray-400 transition duration-500">Details</h2>

                <div className="mt-4 space-y-6">
                  <p className="text-sm text-gray-600 dark:text-gray-400 transition duration-500">{product.details}</p>
                </div>
              </div>
            </div>
          </div>
