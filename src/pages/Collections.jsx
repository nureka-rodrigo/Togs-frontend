...
import collections from "../data/CollectionData.jsx";
      ...
      <section className="flex-grow">
        <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 lg:py-12 lg:max-w-7xl">
          ...
          <div className="mx-auto max-w-2xl py-10 lg:max-w-none lg:py-12">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white transition duration-500">Men&apos;s
              Collection</h2>
            ...
            <div className="mt-6 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:space-y-0">
              {collections.map((callout) => (
                <div key={callout.name} className="group relative">
                  ...
                  <p
                    className="text-base font-semibold text-gray-900 dark:text-white transition duration-500">{callout.description}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="mx-auto max-w-2xl py-10 lg:max-w-none lg:py-12">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white transition duration-500">Women&apos;s
              Collection</h2>
