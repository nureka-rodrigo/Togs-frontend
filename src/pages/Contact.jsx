              ...
              <div className="mt-12 grid items-center lg:grid-cols-2 gap-6 lg:gap-16">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            className="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600 transition duration-500"
                ...
                <div className="divide-y divide-gray-200 dark:divide-gray-800 transition duration-500">
                  <div className="flex gap-x-7 py-6">
                    <svg
                      className="flex-shrink-0 size-6 mt-1.5 text-gray-800 dark:text-gray-200 transition duration-500"
                  ...
                  <div className=" flex gap-x-7 py-6">
                    ...
                    <div className="grow">
                      ...
                      <a
                        className="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 transition duration-500 transition duration-500"
                        href="#"
                      >
                        Contact sales
                        <svg
